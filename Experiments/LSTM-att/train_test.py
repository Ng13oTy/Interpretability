...
# the dir to save test result
result_dir = 'result/'

m_number = 0  # after training one model, need to change the model id here manually. Ten models totally(0-9)
...
# the pre-trained w2v model with corpus of source code
